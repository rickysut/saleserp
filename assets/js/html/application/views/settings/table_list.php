			           			...
			           			<thead>
									...
									{table_list}
										<tr>
											...
											<center>
												<?php echo form_open()?>
												<a href="<?php echo base_url('Csettings/table_edit/{account_id}'); ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
												<?php echo form_close()?>	
											</center>
										</td>
										</tr>
